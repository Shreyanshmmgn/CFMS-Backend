  ...
  return new Promise((res, rej) => {
    ...
    const message = {
      ...
      html: `
        ...
        <p>To activate your account please follow this link: <a target="_" href="https://main.d27jkfy1s4oxp5.amplifyapp.com/api/activate/user/${_id}">${process.env.DOMAIN}/activate </a></p>
        <p>Cheers</p>
        <p>CFMS</p>
      `,
    };
  ...
  new Promise((res, rej) => {
    ...
    const message = {
      ...
      html: `
        ...
        <p> <a target="_" href="https://main.d27jkfy1s4oxp5.amplifyapp.com/changePassword/${email}">${process.env.DOMAIN}/forogtPassword</a></p>
        <p>Regards</p>
        <p>CFMS</p>
      `,
    };
